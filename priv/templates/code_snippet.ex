defmodule <%= @module_name %>Web.Components.CodeSnippet do
  ...
  attr(:background_color, :string, default: "pink-200")
  attr(:text_color, :string, default: "purple-900")
  ...
  def code_snippet(assigns) do
    ...
    <div class={["w-fit min-w-[18rem] rounded-xl bg-#{@background_color} py-5 text-#{@text_color}", @parent_class]} {@rest}>
      ...
      <pre before={@delimiter} class={["whitespace-pre-line px-8 mt-6 before:opacity-50 before:content-[attr(before)]", @class]}>
